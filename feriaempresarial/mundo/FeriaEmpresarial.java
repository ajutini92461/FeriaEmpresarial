...
public class FeriaEmpresarial {
     ...
     */
     public String metodo1(){
         ...
         ArrayList<Expositores> PExpo = new ArrayList<Expositores>();
         Expositores c = new Expositores();
         c.setNExpositores(0);
         Expositores n = new Expositores();
         n.setNExpositores(0);
         Expositores s = new Expositores();
         s.setNExpositores(0);
         Expositores o = new Expositores();
         o.setNExpositores(0);
         Expositores oc = new Expositores();
         oc.setNExpositores(0);
                 ...
                 for (Empresa empresa: empresas){
                     if (empresa.darTipo().equals(Empresa.EXPOSITORA)){
                         if (empresa.darNombre().equals(puesto.darNombreEmpresa())){
                             if (puesto.darZona().equals("Zona centro")){
                                 c.setNExpositores(
                                         c.getNExpositores() + empresa.darNumeroPersonasAsistentes());
                                 c.setZona("Zona centro");
                             }
                             else if (puesto.darZona().equals("Zona norte")){
                                 n.setNExpositores(
                                         n.getNExpositores() + empresa.darNumeroPersonasAsistentes());
                                 n.setZona("Zona norte");
                             }
                             else if (puesto.darZona().equals("Zona sur")){
                                 s.setNExpositores(
                                         s.getNExpositores() + empresa.darNumeroPersonasAsistentes());
                                 s.setZona("Zona sur");
                             }
                             else if (puesto.darZona().equals("Zona oriente")){
                                 o.setNExpositores(
                                         o.getNExpositores() + empresa.darNumeroPersonasAsistentes());
                                 o.setZona("Zona oriente");
                             }
                             else if (puesto.darZona().equals("Zona occidente")){
                                 oc.setNExpositores(
                                         oc.getNExpositores() + empresa.darNumeroPersonasAsistentes());
                                 oc.setZona("Zona occidente");
                             }
                         }
                     }
                 }
         ...
         Expositores Mayorn = new Expositores();
         Mayorn.setNExpositores(0);

         for(Expositores pZ: PExpo){
             if(pZ.getNExpositores() > Mayorn.getNExpositores()){
                 Mayorn.setNExpositores(pZ.getNExpositores());
                 Mayorn.setZona(pZ.getZona());
             }
         }

         return "La zona con mayor número de expositores es la: " + Mayorn.getZona();
